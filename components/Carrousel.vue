<template>
  <div class="carousel relative  bg-white ">
    <div class="carousel-inner relative overflow-hidden container mx-auto">
      <!--Slide 1-->
      <input
        class="carousel-open mb-10"
        type="radio"
        id="carousel-1"
        name="carousel"
        aria-hidden="true"
      ...
      <div class="carousel-item absolute opacity-0" style="height: 50vh">
        <img
          ...
          alt="diverpark alquiler toro mecánico mallorca palma baleares"
          slot="svg"
        />
      </div>
      <label
