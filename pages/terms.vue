...
<div class="flex items-center justify-center h-screen bg-gray-200">
  ...
  <div class="bg-white rounded-lg shadow-lg p-5 md:p-20 mx-2">
    ...
    <p>Welcome to diverpark.net!</p>

    <p>
      These terms and conditions outline the rules and regulations for the use
      of diverpark's Website, located at diverpark.net.
    </p>

    <p>
      By accessing this website we assume you accept these terms and conditions.
      Do not continue to use diverpark.net if you do not agree to take all of
    ...
    <p>
      We employ the use of cookies. By accessing diverpark.net, you agreed to
      use cookies in agreement with the diverpark's Privacy Policy.
    </p>
    ...
    <p>
      Unless otherwise stated, diverpark and/or its licensors own the
      intellectual property rights for all material on diverpark.net. All
      intellectual property rights are reserved. You may access this from
      diverpark.net for your own personal use subjected to restrictions set in
      these terms and conditions.
    </p>

    <p>You must not:</p>
    <ul>
      <li>Republish material from diverpark.net</li>
      <li>Sell, rent or sub-license material from diverpark.net</li>
      <li>Reproduce, duplicate or copy material from diverpark.net</li>
      <li>Redistribute content from diverpark.net</li>
    </ul>
    ...
    <p>
      ...
      opinions and information in certain areas of the website. diverpark does
      ...
      diverpark,its agents and/or affiliates. Comments reflect the views and
      opinions of the person who post their views and opinions. To the extent
      permitted by applicable laws, diverpark shall not be liable for the
    ...
    <p>
      diverpark reserves the right to monitor all Comments and to remove any
    ...
    <p>
      You hereby grant diverpark a non-exclusive license to use, reproduce, edit
    ...
    <p>
      ...
      hyperlink compensates the absence of diverpark; and (d) the link is in the
    ...
    <p>
      ...
      e-mail to diverpark. Please include your name, your organization name,
    ...
    <p>
      No use of diverpark's logo or other artwork will be allowed for linking
