<template>
  <div class="bg-gray-100 text-gray-100 px-8 py-12 pt-24">
      <div
        ...
        <div class="flex flex-col justify-between">
          <div>
            <h2 class="text-4xl lg:text-5xl font-bold leading-tight">              {{ $t('contact.title') }}</h2>
        ...
        <div class="">
          <div>
            <span class="uppercase text-sm text-gray-600 font-bold">            {{ $t('common.name') }} </span>
            <input class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
              type="text" placeholder="">
          </div>
          <div class="mt-8">
            <span class="uppercase text-sm text-gray-600 font-bold">            {{ $t('common.email') }} </span>
            <input class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
              type="text">
          </div>
          <div class="mt-8">
            <span class="uppercase text-sm text-gray-600 font-bold">{{ $t('common.message') }}</span>
            <textarea
